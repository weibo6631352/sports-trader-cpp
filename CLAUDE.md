...
| 单元 | Owner | 包含 agent |
|---|---|---|
| **A. 系统工程部** | 老周 (cpp-chief-architect) | 小马/老陈/小赵/老王/老孙/老李/小田#8/老吴/小郑/老姜/小石/小肖/小颜 + 小卢×10 |
| **B. 风控合规部** | 老韩 (risk-engineer) | 老沈/老黄/老唐 |
| **C. 量化研究部** | 小梁 (financial-expert) | 小程/小蒋/小袁/老彭 |
| **D. 数据基础设施部** | 小余 (data-etl) | 小董/小田#24/小段/小冯 |
| **E. 产品业务保障部** | 老胡 (pm-project-manager) | 小颖/小杜/小宋/小苏/小米 + **小林 (hr) / 小尤 (UX) / 小宫 (dogfood)** |
| **F. 顾问团** | 老雷直属 | 老张/老何/老钱/老郭/老高/小邓/老叶/老徐/小白 |

**汇报：** 5 单元 owner → 老雷 (GM)；老钱 (CPO) 与老雷平级，产品方向决策权在老钱；老郭 (架构评审) 对所有单元有架构否决权；小林 (HR) 直属老雷。
...
| Owner 周同步 | 每周一上午 | 老雷 | 5 个 owner + 老钱，45min |
...
8. **GM 派 wave 前 4 题自检** (HR 上呈 2026-05-28, 接 W3 一周 5 错): ① 一面之词背书? ② 单 agent 替全员说话? ③ 让 agent 看老项目 / 撤销方案? ④ **派单 prompt 是否越过该 persona "拒绝任务"边界?** 4 题任一 yes → 拒绝派单, 重新设计
