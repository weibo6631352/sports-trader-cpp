...
// 持仓管理 Stage 2 P0: per-event 相关性集中度 cap (R6.2c)
CASE(EXCEED_EVENT_EXPOSURE,     EXCEED_EVENT_EXPOSURE)
...
TEST_F(RiskManagerFixture, INVALID_INTENT_with_sub_reason_TS_ORDER_VIOLATED) {
    gw_->prime_reject("s_inv", RejectCode::INVALID_INTENT,
                      InvalidIntentSubReason::TS_ORDER_VIOLATED);
