...
[[nodiscard]] constexpr std::string_view ToString(WalError e) noexcept {
    switch (e) {
        case WalError::Ok:                  return "Ok";
        case WalError::PitViolation:        return "PitViolation";
        case WalError::Backpressure:        return "Backpressure";
        case WalError::FsyncFailed:         return "FsyncFailed";
        case WalError::PathPrefixMismatch:  return "PathPrefixMismatch";
        case WalError::VersionMismatch:     return "VersionMismatch";
        case WalError::CrcMismatch:         return "CrcMismatch";
        case WalError::SeqGap:              return "SeqGap";
        case WalError::UlidNonMonotonic:    return "UlidNonMonotonic";
        case WalError::MidCorruption:       return "MidCorruption";
        case WalError::TailTruncated:       return "TailTruncated";
        case WalError::DiskFull:            return "DiskFull";
        case WalError::Io:                  return "Io";
    }
    return "unknown";
}
