...
[[nodiscard]] constexpr std::string_view phase_name(InplayPhase p) noexcept {
    switch (p) {
        case InplayPhase::Pregame:
            return "Pregame";
        case InplayPhase::Early:
            return "Early";
        case InplayPhase::Mid:
            return "Mid";
        case InplayPhase::Late:
            return "Late";
    }
    return "Unknown";
}
...
inline constexpr std::array<std::array<SportFillRateProfile, kNumPhases>, kNumSports> kSportProfiles = {{
...
[[nodiscard]] constexpr SportFillRateProfile const& profile_of(Sport s, InplayPhase p) noexcept {
