...
private:
    ...
    static void WriteLine(std::ofstream& out, const std::string& cond, const sizing::QuoteFeatures& q) {
        ...
        out << "{\"condition_id\":\"" << cond << "\""
            ...
            // 短时套利信号 (advisory 旁路观测)
            << ",\"arb_actionable\":" << JsonNum(q.arb_actionable)
            << ",\"arb_horizon_sec\":" << JsonNum(q.arb_horizon_sec)
            << ",\"arb_predicted_dmid\":" << JsonNum(q.arb_predicted_dmid)
            << ",\"arb_net_edge\":" << JsonNum(q.arb_net_edge)
            << ",\"arb_signal_quality\":" << JsonNum(q.arb_signal_quality)
            << ",\"arb_suggested_notional\":" << JsonNum(q.arb_suggested_notional)
            << ",\"arb_reject_code\":" << JsonNum(q.arb_reject_code)
            ...
            // v0.10 trade-flow (双边独立)
            << ",\"b_trade_signed_vol_5m\":" << JsonNum(q.b_trade_signed_vol_5m)
            << ",\"b_trade_buy_ratio_5m\":" << JsonNum(q.b_trade_buy_ratio_5m)
            << ",\"b_trade_intensity_5m\":" << JsonNum(q.b_trade_intensity_5m)
            << ",\"no_b_trade_signed_vol_5m\":" << JsonNum(q.no_b_trade_signed_vol_5m)
            << ",\"no_b_trade_buy_ratio_5m\":" << JsonNum(q.no_b_trade_buy_ratio_5m)
            << ",\"no_b_trade_intensity_5m\":" << JsonNum(q.no_b_trade_intensity_5m)
