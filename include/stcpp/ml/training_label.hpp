...
[[nodiscard]] constexpr std::string_view to_string(SettlementOutcome o) noexcept {
    switch (o) {
        case SettlementOutcome::Pending: return "Pending";
        case SettlementOutcome::Win:     return "Win";
        case SettlementOutcome::Loss:    return "Loss";
        case SettlementOutcome::Push:    return "Push";
        case SettlementOutcome::Void:    return "Void";
    }
    return "unknown";
}
...
static_assert(stcpp::infra::wal::WalRecord<TrainingLabel>,
              "TrainingLabel 必须满足 WalRecord concept");
