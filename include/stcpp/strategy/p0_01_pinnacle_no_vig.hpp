...
class IPinnacleSource {
 public:
    ...
    [[nodiscard]] virtual bool lookup(std::string const& market_id,
                                      PinnacleQuote& out) const noexcept = 0;
};
...
class MockPinnacleSource : public IPinnacleSource {
 public:
    ...
    [[nodiscard]] bool lookup(std::string const& market_id,
                              PinnacleQuote& out) const noexcept override;
...
class IPmSnapshotSource {
 public:
    ...
    [[nodiscard]] virtual bool lookup(std::string const& market_id,
                                      PmSnapshot& out) const noexcept = 0;
};
...
class MockPmSnapshotSource : public IPmSnapshotSource {
 public:
    ...
    [[nodiscard]] bool lookup(std::string const& market_id,
                              PmSnapshot& out) const noexcept override;
...
class IGameStateSource {
 public:
    ...
    [[nodiscard]] virtual bool lookup(std::string const& market_id,
                                      GameState& out) const noexcept = 0;
};
...
class MockGameStateSource : public IGameStateSource {
 public:
    ...
    [[nodiscard]] bool lookup(std::string const& market_id,
                              GameState& out) const noexcept override;
...
class PinnacleNoVigSignal final : public ISignalEngine {
 public:
    ...
    PinnacleNoVigSignal(IPinnacleSource const& pinnacle,
    ...
    [[nodiscard]] SignalId id() const noexcept override {
        return SignalId::P0_01_PinnacleNoVig;
    }
