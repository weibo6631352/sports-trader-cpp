...
[[nodiscard]] constexpr std::string_view SportInplaySlug(GoalserveSport s) noexcept {
    switch (s) {
        case GoalserveSport::Soccer:
            return "soccer";
        case GoalserveSport::Basketball:
            return "basket";  // 简写 != bsktbl
        case GoalserveSport::Tennis:
            return "tennis";
        case GoalserveSport::Volleyball:
            return "volleyball";
        case GoalserveSport::AmericanFootball:
            return "amfootball";  // 注: am 前缀
        case GoalserveSport::Esports:
            return "esports";
        case GoalserveSport::Hockey:
            return "hockey";
        case GoalserveSport::Baseball:
            return "baseball";
    }
    return "";
}
...
[[nodiscard]] constexpr std::string_view SportPregameSlug(GoalserveSport s) noexcept {
    switch (s) {
        case GoalserveSport::Soccer:
            return "soccernew";
        case GoalserveSport::Basketball:
            return "bsktbl";  // 注: 与 inplay/basket 不同
        case GoalserveSport::Tennis:
            return "tennis_scores";
        case GoalserveSport::Volleyball:
            return "volleyball";
        case GoalserveSport::AmericanFootball:
            return "football";  // www 用 football
        case GoalserveSport::Esports:
            return "esports";
        case GoalserveSport::Hockey:
            return "hockey";
...
inline constexpr std::array<TimeStatus, 11> kAllTimeStatus{
    TimeStatus::NotStarted, TimeStatus::InPlay,    TimeStatus::ToBeFixed, TimeStatus::Ended,
    TimeStatus::Postponed,  TimeStatus::Cancelled, TimeStatus::Walkover,  TimeStatus::Interrupted,
    TimeStatus::Abandoned,  TimeStatus::Retired,   TimeStatus::Removed,
};

[[nodiscard]] constexpr std::string_view TimeStatusName(TimeStatus t) noexcept {
    switch (t) {
        case TimeStatus::NotStarted:
            return "NotStarted";
        case TimeStatus::InPlay:
            return "InPlay";
        case TimeStatus::ToBeFixed:
            return "ToBeFixed";
        case TimeStatus::Ended:
            return "Ended";
        case TimeStatus::Postponed:
            return "Postponed";
        case TimeStatus::Cancelled:
            return "Cancelled";
        case TimeStatus::Walkover:
            return "Walkover";
        case TimeStatus::Interrupted:
            return "Interrupted";
        case TimeStatus::Abandoned:
            return "Abandoned";
        case TimeStatus::Retired:
            return "Retired";
        case TimeStatus::Removed:
            return "Removed";
    }
    return "Unknown";
}
...
[[nodiscard]] constexpr bool IsTerminal(TimeStatus t) noexcept {
    ...
    return t == TimeStatus::Ended || t == TimeStatus::Postponed || t == TimeStatus::Cancelled ||
           t == TimeStatus::Walkover || t == TimeStatus::Abandoned || t == TimeStatus::Retired ||
...
public:
    ...
    [[nodiscard]] GoalserveResponse FetchWithTsDelta(GoalserveHost host, GoalserveEndpoint endpoint,
                                                     GoalserveSport sport, std::int64_t last_ts_ms);

    // helper: 解析 scores@ts ms epoch → ns (R-20 data_source_ts 主路径)
    [[nodiscard]] static std::int64_t TsMsToNs(std::int64_t ts_ms) noexcept { return ts_ms * 1'000'000LL; }
