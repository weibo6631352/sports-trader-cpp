  ...
  positions: [
    {
      ...
      pnl_realized: 45.0,
      pnl_unrealized: 45.0,
      event_ts: NOW_NS - 6e10,
      data_source_ts: NOW_NS - 5.9e10,
      ingestion_ts: NOW_NS - 5.8e10,
    },
    {
      ...
      pnl_realized: -12.5,
      pnl_unrealized: -24.0,
      event_ts: NOW_NS - 3e10,
      data_source_ts: NOW_NS - 2.9e10,
      ingestion_ts: NOW_NS - 2.8e10,
    },
    {
      ...
      pnl_realized: 110.0,
      pnl_unrealized: 66.0,
      event_ts: NOW_NS - 1e10,
      data_source_ts: NOW_NS - 9.5e9,
      ingestion_ts: NOW_NS - 9e9,
    },
  ],
};
...
export const STUB_PNL_ATTRIBUTION = {
  ...
  as_of_ts: NOW_NS,
  waterfall: [
    { label: 'gross_pnl', value: 312.5 },
    { label: 'fee', value: -18.3 },
    { label: 'gas', value: -2.1 },
    { label: 'slippage', value: -9.7 },
    { label: 'spread_capture', value: 24.6 },
    { label: 'net_pnl', value: 307.0 },
  ],
  per_market: [
  ...
  rejects: [
    {
      ...
      price: 0.41,
      event_ts: NOW_NS - 2e9,
      data_source_ts: NOW_NS - 1.9e9,
      ingestion_ts: NOW_NS - 1.8e9,
      as_of_ts: NOW_NS,
    },
    {
      reject_id: 'rj-0002',
      ...
      size: 100,
      price: 0.88,
      event_ts: NOW_NS - 1.2e10,
      data_source_ts: NOW_NS - 1.19e10,
      ingestion_ts: NOW_NS - 1.18e10,
      as_of_ts: NOW_NS,
    },
  ],
};
