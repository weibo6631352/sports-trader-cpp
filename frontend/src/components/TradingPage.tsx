...
import {
  isMarketExpanded, toggleMarket, isEventExpanded, toggleEvent, expandAllMarkets, collapseAllMarkets,
  marketTypeColor, marketTypeShort, stalenessClass, stalenessText,
} from './trading/shared';  // 展开状态 + 类型/延迟 helper 已拆出 (架构师 A3)
import { GlobalHealthBar } from './trading/GlobalHealthBar';  // 全局健康栏已拆出 (架构师 A3)
