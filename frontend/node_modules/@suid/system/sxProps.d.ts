...
export type SxPropsBase<T = Theme> = Omit<StyledPropsBase, keyof SystemProps<T>> & StyledPropsBase & SystemProps<Theme>;
export type SxCascade<Sx, T = Theme> = {
    [K in keyof Sx]?: ResponsiveStyleValue<Sx[K]> | ((theme: T) => ResponsiveStyleValue<Sx[K]>);
} | {
