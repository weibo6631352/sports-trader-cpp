...
export interface BackdropUnstyledTypeMap<P = {}, D extends ElementType = "div"> {
    ...
    selfProps: {
         ...
         */
        componentsProps?: {
            root?: JSX.HTMLAttributes<HTMLDivElement> & BackdropUnstyledComponentsPropsOverrides;
        };
        /**
...
export type BackdropUnstyledProps<D extends ElementType = BackdropUnstyledTypeMap["defaultComponent"], P = {}> = OverrideProps<BackdropUnstyledTypeMap<P, D>, D>;
export default BackdropUnstyledProps;
//# sourceMappingURL=BackdropUnstyledProps.d.ts.map