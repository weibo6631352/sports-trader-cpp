...
export type TableFooterProps<D extends ST.ElementType = TableFooterTypeMap["defaultComponent"], P = {}> = ST.OverrideProps<TableFooterTypeMap<P, D>, D>;
export default TableFooterProps;
//# sourceMappingURL=TableFooterProps.d.ts.map