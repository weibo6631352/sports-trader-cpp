...
export type PopoverTypeMap<P = {}, D extends ST.ElementType = "div"> = {
    name: "MuiPopover";
    defaultPropNames: "anchorOrigin" | "anchorReference" | "elevation" | "marginThreshold" | "PaperProps" | "transformOrigin" | "TransitionComponent" | "transitionDuration" | "TransitionProps";
    selfProps: {
        /**
    ...
    props: P & PopoverTypeMap["selfProps"] & Omit<ModalTypeMap["props"], "children">;
    defaultComponent: D;
};
export type PopoverProps<D extends ST.ElementType = PopoverTypeMap["defaultComponent"], P = {}> = ST.OverrideProps<PopoverTypeMap<P, D>, D>;
