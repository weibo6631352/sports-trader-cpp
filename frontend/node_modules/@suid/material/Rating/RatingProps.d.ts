...
export interface IconContainerProps extends JSX.HTMLAttributes<HTMLSpanElement> {
    value: number;
}
...
export type RatingTypeMap<P = {}, D extends ST.ElementType = "div"> = {
    name: "MuiRating";
    defaultPropNames: "defaultValue" | "disabled" | "emptyIcon" | "emptyLabelText" | "getLabelText" | "highlightSelectedOnly" | "icon" | "IconContainerComponent" | "max" | "precision" | "readOnly" | "size";
    selfProps: {
        /**
    ...
    props: P & RatingTypeMap["selfProps"] & Omit<ST.PropsOf<"span">, "children" | "onChange">;
    defaultComponent: D;
};
export type RatingProps<D extends ST.ElementType = RatingTypeMap["defaultComponent"], P = {}> = ST.OverrideProps<RatingTypeMap<P, D>, D>;
export default RatingProps;
//# sourceMappingURL=RatingProps.d.ts.map