...
export type PaginationItemTypeMap<P = {}, D extends ST.ElementType = "div"> = {
    ...
    defaultPropNames: "color" | "components" | "disabled" | "selected" | "shape" | "size" | "type" | "variant";
    selfProps: {
        /**
...
export type PaginationItemProps<D extends ST.ElementType = PaginationItemTypeMap["defaultComponent"], P = {}> = ST.OverrideProps<PaginationItemTypeMap<P, D>, D>;
export default PaginationItemProps;
//# sourceMappingURL=PaginationItemProps.d.ts.map