...
export type CardActionAreaTypeMap<P = {}, D extends ElementType = "button"> = {
    ...
    props: P & Omit<ButtonBaseTypeMap["props"], "classes"> & CardActionAreaTypeMap["selfProps"];
    defaultComponent: D;
};
export type CardActionAreaProps<D extends ElementType = ButtonBaseTypeMap["defaultComponent"], P = {}> = OverrideProps<CardActionAreaTypeMap<P, D>, D>;
