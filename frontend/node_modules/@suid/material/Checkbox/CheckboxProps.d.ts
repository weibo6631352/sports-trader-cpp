...
export interface CheckboxTypeMap<P = {}, D extends ElementType = "div"> {
    name: "MuiCheckbox";
    defaultPropNames: "checkedIcon" | "color" | "icon" | "indeterminate" | "indeterminateIcon" | "size";
    selfProps: {
        /**
    ...
    props: P & CheckboxTypeMap["selfProps"] & Omit<SwitchBaseProps, "checkedIcon" | "color" | "icon" | "type">;
    defaultComponent: D;
}
