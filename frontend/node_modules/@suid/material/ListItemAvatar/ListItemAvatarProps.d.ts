...
export type ListItemAvatarProps<D extends ElementType = ListItemAvatarTypeMap["defaultComponent"], P = {}> = OverrideProps<ListItemAvatarTypeMap<P, D>, D>;
export default ListItemAvatarProps;
//# sourceMappingURL=ListItemAvatarProps.d.ts.map