...
export type PaginationTypeMap<P = {}, D extends ST.ElementType = "div"> = {
    ...
    props: P & PaginationTypeMap["selfProps"] & UsePaginationProps & Omit<ST.PropsOf<"abbr">, "children" | "onChange">;
    defaultComponent: D;
};
export type PaginationProps<D extends ST.ElementType = PaginationTypeMap["defaultComponent"], P = {}> = ST.OverrideProps<PaginationTypeMap<P, D>, D>;
