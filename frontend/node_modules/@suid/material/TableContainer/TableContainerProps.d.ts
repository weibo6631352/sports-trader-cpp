...
export type TableContainerProps<D extends ST.ElementType = TableContainerTypeMap["defaultComponent"], P = {}> = OverrideProps<TableContainerTypeMap<P, D>, D>;
export default TableContainerProps;
//# sourceMappingURL=TableContainerProps.d.ts.map