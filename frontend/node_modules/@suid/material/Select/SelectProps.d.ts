...
export type SelectTypeMap<P = {}, D extends ST.ElementType = "div", V = any> = {
    name: "MuiSelect";
    defaultPropNames: "autoWidth" | "classes" | "defaultOpen" | "displayEmpty" | "IconComponent" | "multiple" | "native" | "variant";
    selfProps: {
        /**
    ...
    props: P & SelectTypeMap<P, D, V>["selfProps"] & Omit<InputProps, "value" | "onChange"> & Omit<OutlinedInputProps, "value" | "onChange"> & Pick<SelectInputProps<D, P, V>, "onChange">;
    defaultComponent: D;
};
export type SelectProps<D extends ST.ElementType = SelectTypeMap["defaultComponent"], P = {}> = ST.OverrideProps<SelectTypeMap<P, D>, D>;
